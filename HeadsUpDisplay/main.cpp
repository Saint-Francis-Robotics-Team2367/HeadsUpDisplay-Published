...
int main(int argc, const char * argv[]) {
    ...
    hud->addTextList();
    hud->addGauge(300, 200, 0, 100, 100, 50, 250, 100, 255);//int x, int y, int lowerRange, int upperRange, int size, int r, int g, int b, int alpha, double increment, int startingValue, bool showMin, bool showMax
